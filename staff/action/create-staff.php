    ...
    if ($pass === $pass2){
		...
		if(mysqli_num_rows($results)>0){ 
            ...
            if ($link->query($sql2) === TRUE) {
                echo "The profile created successfully";
            } else {
        ...
        header("Location: ../interface/Create-Student.php?error=unmatchpassword");
    }
} else {
    header("Location: ../interface/Create-Student.php?error=unclick");
    exit();
}
?>