				...
				<div class="container bg-light card body">
					...
					<form action="../action/create-lect.php" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-8">
								<input placeholder="Country" class="form-control here" name ="state" type="text" required=required>
							</div>
					    </div>
						<div class="form-group row">
							<label class="col-3 col-form-label">Country</label> 
							<div class="col-8">
								<input placeholder="State" class="form-control here" name ="country" type="text" required=required>
							</div>
					    </div>
					    <div class="form-group row">
