				...
				<div class="container bg-light card body">
					...
					<form action="../action/edit-student.php?id=<?php echo $id;?>" method="post">
						<div class="form-group row">
							...
							<div class="col-8">
								<input value="<?php echo $name;?>" class="form-control here" type="text" name="name">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-8">
								<input value="<?php echo $dob;?>" class="form-control here" type="date" name="dob">
							</div>
						</div>
						<div class="form-group row">
						<label class="col-3 col-form-label">Phone Number</label> 
							<div class="col-8">
								<input value="<?php echo $num;?>"	 class="form-control here" type="text" name="num">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-8">
								<input value="<?php echo $email;?>" class="form-control here" type="text" name="email">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-3 col-form-label">Street</label> 
							<div class="col-8">
								<input value="<?php echo $street;?>" class="form-control here" type="text" name="street">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-3 col-form-label">State</label> 
							<div class="col-8">
								<input value="<?php echo $state;?>" class="form-control here" type="text" name="state">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-3 col-form-label">City</label> 
							<div class="col-8">
								<input value="<?php echo $city;?>" class="form-control here" type="text" name="city">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-3 col-form-label">Postcode</label> 
							<div class="col-8">
								<input value="<?php echo $postcode;?>" class="form-control here" type="text" name="postcode">
							</div>
						</div><div class="form-group row">
							<label class="col-3 col-form-label">Country</label> 
							<div class="col-8">
								<input value="<?php echo $country;?>" class="form-control here" type="text" name="country">
							</div>
						</div>
						<div class="form-group row">
