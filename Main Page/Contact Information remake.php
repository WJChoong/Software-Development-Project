		...
		<div class="card" style="height: auto; margin-top: auto; margin-bottom: auto; width: auto; background-color: rgba(0,0,0,0.5)">
			...
			<li class="nav-item">
				...
				<div class="dropdown-menu">
					...
					<a href="Contact Information remake.php" class="dropdown-item"><b>Contact Information</b></a>
			    </div></div>
			</li>
			</ul>
			</div></center>
			...
			<p><i class="fa fa-envelope" style='color:red'></i> apustudentservice@gmail.com</p>
			</div></div>
